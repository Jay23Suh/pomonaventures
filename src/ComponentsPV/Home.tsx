    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-brand-blue-deep/85 to-brand-blue-deep/95"></div>
          {/* Subtle orange glow in corner */}
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-orange/10 blur-[120px] rounded-full -mr-64 -mt-64"></div>
        </div>

        {/* Hero Content */}
        <div className="relative z-10 max-w-4xl mx-auto">
          <img src="/PVWhite.png" alt="Pomona Ventures" className="w-24 h-auto mx-auto mb-8 animate-fade-in drop-shadow-2xl" />
          
          <p className="font-heading text-brand-orange font-bold tracking-widest uppercase mb-4 animate-slide-up drop-shadow-md">
            The Hub for Entrepreneurship at the Claremont Colleges
          </p>
          
          <h1 className="font-heading text-5xl md:text-7xl font-bold text-white mb-6 leading-tight animate-slide-up drop-shadow-xl">
            Empowering the Next Generation of <span className="text-brand-orange drop-shadow-sm">Founders</span>.
          </h1>
          
          <p className="text-xl md:text-2xl text-white font-medium mb-10 max-w-2xl mx-auto leading-relaxed animate-slide-up delay-100 drop-shadow-lg">
      ...
      {/* Mission Section - More Orange/Blue integrated */}
      <section className="py-32 px-4 bg-white relative overflow-hidden">
        {/* Decorative background elements */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-brand-orange/5 blur-3xl rounded-full -mr-48 -mt-24"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-blue/5 blur-3xl rounded-full -ml-48 -mb-24"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="h-2 w-12 bg-brand-blue rounded-full"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* Card 1: Resources - Light Blue with Orange Accents */}
            <div className="group p-10 bg-blue-50 rounded-3xl border-2 border-brand-blue/20 hover:border-brand-orange transition-all duration-500 shadow-xl hover:shadow-brand-orange/10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-brand-orange/10 rounded-full -mr-16 -mt-16 group-hover:bg-brand-orange/20 transition-colors"></div>
              ...
              <div className="h-2 w-16 bg-brand-orange mt-8 rounded-full"></div>
            </div>

            {/* Card 2: Community - Light Orange with Blue Accents */}
            <div className="group p-10 bg-orange-50 rounded-3xl border-2 border-brand-orange/20 hover:border-brand-blue transition-all duration-500 shadow-xl hover:shadow-brand-blue/10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-brand-blue/10 rounded-full -mr-16 -mt-16 group-hover:bg-brand-blue/20 transition-colors"></div>
              ...
              <div className="h-2 w-16 bg-brand-blue mt-8 rounded-full"></div>
            </div>

            {/* Card 3: Initiatives - Light Blue with Orange Accents */}
            <div className="group p-10 bg-blue-50 rounded-3xl border-2 border-brand-blue/20 hover:border-brand-orange transition-all duration-500 shadow-xl hover:shadow-brand-orange/10 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-brand-orange/10 rounded-full -mr-16 -mt-16 group-hover:bg-brand-orange/20 transition-colors"></div>
              <div className="w-16 h-16 bg-gradient-to-br from-brand-blue-deep to-brand-blue text-black rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-brand-blue-deep/20 group-hover:from-brand-orange group-hover:to-brand-orange-hover group-hover:rotate-6 transition-all duration-300">
                <svg className="w-10 h-10" fill="none" stroke="black" viewBox="0 0 24 24">
      ...
      {/* Image Gallery Section - Dark Theme with Glass & Glow */}
      <section className="py-32 px-4 bg-brand-blue-deep relative overflow-hidden">
        {/* Vibrant background glows for depth */}
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-brand-blue/20 blur-[120px] rounded-full opacity-50"></div>
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-brand-orange/10 blur-[100px] rounded-full opacity-30"></div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
            {/* The Glass Container - Increased opacity for black text contrast */}
            <div className="max-w-2xl bg-white/80 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/20 shadow-2xl">
              <h2 className="text-4xl md:text-6xl font-heading font-bold text-black mb-6">Our Community in Action</h2>
              <div className="h-2 w-24 bg-brand-orange rounded-full mb-8 shadow-lg shadow-brand-orange/20"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[250px]">
            <div className="md:col-span-2 md:row-span-2 overflow-hidden rounded-[2rem] group relative shadow-2xl border-4 border-white/10">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-brand-blue-deep to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-300"></div>
      ...
      <section className="py-32 px-4 bg-white relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-5">
           <div className="grid grid-cols-6 gap-4 rotate-12 scale-150">
              {[...Array(24)].map((_, i) => (
                <div key={i} className="w-full aspect-square border-2 border-brand-orange rounded-full"></div>
              ))}
           </div>
        </div>
