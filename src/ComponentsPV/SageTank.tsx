export default function SageTank() {
  return (
    ...
    <div className="min-h-screen text-gray-900 flex flex-col">
      <img src="/ST.gif" alt="SageTank event gif" className="w-full h-auto" />

      {/* Hero Section */}
      <section className="relative flex flex-col md:flex-row items-center justify-center text-center py-12 px-4 md:py-20 md:px-6">
        <img src="/sagetank.png" alt="sagetank logo" className="w-48 md:w-80 h-auto mb-8 md:mb-0 md:mr-12 flex-shrink-0" />
      ...
      <section className="py-20 px-6 rounded-t-3xl ">
        ...
        <div className="columns-2 md:columns-3 gap-4 p-6">
          <img src="/DSC00270.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00193.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00291.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00176.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00120.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00130.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00154.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00204.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
          <img src="/DSC00275.jpg" alt="SageTank event highlight" className="mb-4 w-full rounded-lg" />
        </div>
